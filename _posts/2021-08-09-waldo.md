...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149waldoHTB.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149statistics.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 80%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149page80.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149page80_addList.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149page80_sourceCode_listHTML.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149page80_sourceCode_listJS.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_tabs_requests.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Si nos fijamos de los 4 recursos, hay dos muuuy llamativos, `fileRead.php` y `dirRead.php`, inspeccionemos **fileRead.php**:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_fileRead_res.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_fileRead_findLISThtml_fail.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_fileRead_findLISThtml_done.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_fileRead.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
* `$_POST['file'] = str_replace( array("../", ".."), "", $_POST['file']);`
  * Lo que hace es tomar el valor de la variable `file` y si en su contenido existen/encuentra ya sea `../` o `..` los remplaza por: `` (vacío).
  ...
  <img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149bash_scriptPHP_example_strReplace.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_etcPasswd.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_fileRead2dirRead.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_dirRead.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

O podemos ver tooodos los objetos que usa la web simplemente borrando el directorio `.list` de la variable:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_dirRead_list.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_dirRead_list_withpayload.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

😄 ***¿Esa petición es real o solo cambié el valor de la variable `path` para hacerles creer que funciona?***

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_dirRead_rootsystem.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_dirRead_home.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_dirRead_home_nobody.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_dirRead_home_nobody_ssh.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149burp_LFI_fileRead_ssh_monitor.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149bash_ssh_nobodySH.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Perfectisiiiiimo, tamos dentrooooo (:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149google_gif_go_on.gif" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 70%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149bash_ssh_monitorSH1.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149bash_ssh_monitorSH2.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149google_ed_exeCommand.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149bash_nobodySH_ed_bypassRSHELL_done.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149bash_monitorSH_updatingPATHvariable.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149bash_monitorSH_tac_etcShadow.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

VAMOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO podemos leer archivos privilegiaaaados del sistemaaaaaaaaaaaaaaaa.

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149google_gif_comedymanoverhype.gif" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149bash_monitorSH_tac_rootIdRSA.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149user_flag.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/waldo/149root_flag.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
