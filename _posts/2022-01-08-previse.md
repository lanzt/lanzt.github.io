...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373previseHTB.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373rating.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 30%;"/>

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373statistics.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 80%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373page80.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373page80_navPHP.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_proxyOptions_InterceptRES.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_accountsPHP_get.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Damos clic en `forward` para que siga con la petición y obtenemos...

* El código de estado indicando un **redirect** (`302 Found`):

  <img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_accountsPHP_302Found1.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

* Opaaa, tamos viendo la respuesta del archivo `accounts.php`.

  <img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_accountsPHP_302Found2.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

* El formulario con el que envía los datos de creación.

  <img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_accountsPHP_302Found3.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_accountsPHP_200OK.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Damos clic en `forward` para que envíe la petición. Y en la web vemooooooooooooooooooooos:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373page80_accountsPHP.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373page80_dashboard.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Pelfeto, tamos dentro del servidor web (: Visitando **FILES** (que nos lleva a `files.php`) vemos esto:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373page80_filesPHP.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_unzip_siteBackup_files.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_cat_configPHP.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_cat_logsPHP.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_cat_fileLogsPHP.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373page80_fileLogsPHP.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Si interceptamos con `Burp` al momento de dar `Submit` veríamos la petición y el campo `delim`:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_logsPHP_delimNORMAL.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Y si la procesamos:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_logsPHP_delimNORMAL_res.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_logsPHP_delimWHOAMI.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Enviamos yyyyyyyyyyyyyyy:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_logsPHP_delimWHOAMI_fail.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burp_logsPHP_delimWHOAMIandNETCAT.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Enviamos yyyyyyyyyyyyyyyyyyy:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_nc_id_RCEasWWW_delim_commandInjection.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373burl_logsPHP_delimREVSH.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

Lanzamos la petición y en nuestro `netcat`:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_wwwdataRevSH.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_wwwdataSH_mysql.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_wwwdataSH_mysql_SELECTfromACCOUNTS_hashes.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_wwwdataSH_FOUNDm4lwhereUSER.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_hashesWEBSITEdone.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373google_hashEMOJIsalt.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_cat_accountsPHP.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_ssh_m4lwhereSH.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_m4lwhereSH_sudoL.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_echoPATH.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_m4lwhereSH_gzipHIJACKING_idTXT.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
...
<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373bash_rootRevSH.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>

OBTENEMOS UNA SHELL COMO `root`, tamos tamos que tamoooos!!

Ya podríamos ver las flags:

<img src="https://raw.githubusercontent.com/lanzt/blog/main/assets/images/HTB/previse/373flags.png" class="img-to-zoom" data-toggle="modal" data-target=".modal-zoomed-img" style="width: 100%;"/>
